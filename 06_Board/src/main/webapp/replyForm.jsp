<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<!-- content.jsp(ref,re_step,re_level) => replyForm.jsp -->
	...
	<table width="450" border="1" cellspacing="0" cellpadding="0"
		...
		<tr>
			...
			<td width="300" align="left"><input type="text" size="30"
				maxlength="10" name="writer" value="홍길동"></td>
		</tr>

		<tr>
			<td width="150" align="center">제 목</td>
			<td width="300" align="left"><input type="text" size="50"
				maxlength="50" name="subject" value="[답글]어떤글"></td>
		</tr>

		<tr>
			<td width="150" align="center">Email</td>
			<td width="300" align="left"><input type="text" size="50"
				maxlength="30" name="email" value="aa@xx.com"></td>
		</tr>
		...
		<tr>
			...
			<td width="300" align="left"><input type="password" size="10"
				maxlength="12" name="passwd" value="1234"></td>
		</tr>
		<tr>
