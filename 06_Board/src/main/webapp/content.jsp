...
<table>
    ...
    <tr>
        <td colspan="4">
        	...
        	<input type="button" value="글삭제" onClick = "window.location='deleteForm.jsp?num=<%=bb.getNum()%>&pageNum=<%=pageNum%>'"">
        	<input type="button" value="답글쓰기" onClick="window.location='replyForm.jsp?ref=<%=ref%>&re_step=<%=re_step%>&re_level=<%=re_level%>&pageNum=<%=pageNum%>'">
