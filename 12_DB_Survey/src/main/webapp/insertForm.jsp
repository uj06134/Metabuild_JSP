...
<form action="insert.sv" method="post"> 
	...
	소속 회사　　<input type="text" name="company" value=""><br>
	...
	<c:forEach var="sf" items="<%=satisfaction%>">
    <input type="radio" name="satisfaction" value="${sf}">${sf}
    </c:forEach>
	<p>
	...
	정보 발송 방법 <select name="howto">
		<option value="선택없음"  selected="selected">선택없음
